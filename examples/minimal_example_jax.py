...
def main() -> None:
    ...
    config = JaxHouseholderRoPEConfig(mode="shared", num_reflectors=4, init="jittered_pairs", rope_ndim=2)
    ...
    q = jax.random.normal(q_key, (1, 2, 4, 8))
    k = jax.random.normal(k_key, (1, 2, 4, 8))
